...
obj/alloc.o: alloc.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c alloc.c -o $@

obj/arith.o: arith.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c arith.c -o $@

obj/builtins.o: builtins.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
...
obj/errmsg.o: errmsg.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c errmsg.c -o $@

obj/exec.o: exec.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c exec.c -o $@

obj/expand.o: expand.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c expand.c -o $@

obj/glob.o: glob.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c glob.c -o $@

obj/history.o: history.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c history.c -o $@

obj/input.o: input.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
...
obj/lineio.o: lineio.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c lineio.c -o $@

obj/main.o: main.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c main.c -o $@

obj/opts.o: opts.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c opts.c -o $@

obj/parse.o: parse.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c parse.c -o $@

obj/path.o: path.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c path.c -o $@

obj/pipe.o: pipe.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c pipe.c -o $@

obj/printf.o: printf.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
...
obj/simpsh.o: simpsh.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
	@$(CC) $(CFLAGS) -c simpsh.c -o $@

obj/test.o: test.c $(HDR)
	@mkdir -p obj obj/builtins
	@printf '  %s %s\n' "$(CC)" "$<"
...
obj/builtins/basename.o: builtins/basename.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_basename 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/basename.c -o $@; else rm -f $@; fi

obj/builtins/cat.o: builtins/cat.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_cat 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/cat.c -o $@; else rm -f $@; fi

obj/builtins/comm.o: builtins/comm.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_comm 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/comm.c -o $@; else rm -f $@; fi

obj/builtins/cut.o: builtins/cut.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_cut 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/cut.c -o $@; else rm -f $@; fi

obj/builtins/dirname.o: builtins/dirname.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_dirname 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/dirname.c -o $@; else rm -f $@; fi

obj/builtins/expand.o: builtins/expand.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_expand 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/expand.c -o $@; else rm -f $@; fi

obj/builtins/fold.o: builtins/fold.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_fold 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/fold.c -o $@; else rm -f $@; fi

obj/builtins/head.o: builtins/head.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_head 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/head.c -o $@; else rm -f $@; fi

obj/builtins/paste.o: builtins/paste.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_paste 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/paste.c -o $@; else rm -f $@; fi

obj/builtins/readlink.o: builtins/readlink.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_readlink 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/readlink.c -o $@; else rm -f $@; fi

obj/builtins/realpath.o: builtins/realpath.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_realpath 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/realpath.c -o $@; else rm -f $@; fi

obj/builtins/sleep.o: builtins/sleep.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_sleep 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/sleep.c -o $@; else rm -f $@; fi

obj/builtins/sort.o: builtins/sort.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_sort 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/sort.c -o $@; else rm -f $@; fi

obj/builtins/tail.o: builtins/tail.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_tail 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/tail.c -o $@; else rm -f $@; fi

obj/builtins/tee.o: builtins/tee.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_tee 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/tee.c -o $@; else rm -f $@; fi

obj/builtins/tr.o: builtins/tr.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_tr 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/tr.c -o $@; else rm -f $@; fi

obj/builtins/uniq.o: builtins/uniq.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_uniq 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/uniq.c -o $@; else rm -f $@; fi

obj/builtins/wc.o: builtins/wc.c $(HDR)
	@mkdir -p obj obj/builtins
	@if grep -qi "^#define ENABLE_wc 1" config.h; then printf '  %s %s\n' "$(CC)" "$<"; $(CC) $(CFLAGS) -c builtins/wc.c -o $@; else rm -f $@; fi
