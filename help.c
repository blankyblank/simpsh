...
const builtinhelp helpmsgs[] = {
  ...
  { "return",   "[n]",                   returnhelp      },
  { "set",      setusg,                  sethelp         },
  { "shift",    "(placeholder)",         "(placeholder)" },
  { "test",     "[expr]",                testhelp        },
  { "times",    "(placeholder)",         "(placeholder)" },
  { "trap",     "(placeholder)",         "(placeholder)" },
  { "true",     " ",                     truehelp        },
